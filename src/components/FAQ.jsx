...
const FAQ = () => {
  ...
  const answers = [
    ...
    "Yes, absolutely! At Electrapower Engineering, we prioritize both expertise and safety. All our electrical engineers and electricians are fully licensed and possess extensive experience in their respective fields. Our team undergoes rigorous training and continuous professional development to stay up-to-date with the latest industry standards and technologies. This ensures that they are well-equipped to handle any electrical project, big or small, with the utmost professionalism and efficiency. We understand the critical role that electrical systems play in ensuring the safety and functionality of your business or home. That's why we are committed to providing you with the highest level of expertise and workmanship, delivered by a team you can trust.",
